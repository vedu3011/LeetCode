...
class MaximumTotalSubarrayValueII {
	...
	MaximumTotalSubarrayValueII(int[] nums, boolean flag) {
		int n = nums.length;
		this.isMinTree = flag;
...
class Solution {
	long getValue(int l, int r, MaximumTotalSubarrayValueII minST, MaximumTotalSubarrayValueII maxST, int n) {
	...
	public long maxTotalValue(int[] nums, int k) {
		...
		MaximumTotalSubarrayValueII minST = new MaximumTotalSubarrayValueII(nums, true); // true is for minimum
		MaximumTotalSubarrayValueII maxST = new MaximumTotalSubarrayValueII(nums, false); // false is for maximum
